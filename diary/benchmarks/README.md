...
## Measured bookkeeping costs

The 2026-09-05 bookkeeping experiments completed **9 journal-writer calls and
120 MCP-only blocks**. Their costs are reported separately below.
...
The [preliminary recall pilot](RECALL_PILOT.md) is retained as a technical record,
with its raw data and limitations. It is not featured as representative performance
evidence in the framework introduction.
